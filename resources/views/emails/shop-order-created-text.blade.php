...
عنوان التوصيل:
{{ (['abu_dhabi' => 'أبوظبي','abu dhabi' => 'أبوظبي','dubai' => 'دبي','sharjah' => 'الشارقة','ajman' => 'عجمان','umm_al_quwain' => 'أم القيوين','umm al quwain' => 'أم القيوين','ras_al_khaimah' => 'رأس الخيمة','ras al khaimah' => 'رأس الخيمة','fujairah' => 'الفجيرة'][strtolower(trim((string)$order->delivery_emirate))] ?? $order->delivery_emirate) }} - {{ $order->delivery_area }}
