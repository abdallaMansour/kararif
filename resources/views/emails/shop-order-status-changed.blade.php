            ...
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb;">
                <tr>
                    <td style="background:#2563eb;padding:20px;text-align:center;">
                        ...
                        @endif
                        <h2 style="margin:0;color:#ffffff;font-size:22px;">تحديث حالة الطلب</h2>
                    </td>
                </tr>
                <tr>
                    <td style="padding:22px 24px;">
                        ...
                        <p style="margin:14px 0 6px 0;"><strong>الإجمالي الكلي: {{ number_format($order->total_aed, 2) }} درهم</strong></p>
