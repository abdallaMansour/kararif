...
class SeedAvatarsPackagesCouponsPermissionOnlySeeder extends Seeder
{
    public function run(): void
    {
        foreach (
            [
                ['name' => 'avatars', 'ar' => 'الصور الشخصية', 'en' => 'Avatars'],
                ['name' => 'packages', 'ar' => 'الباقات', 'en' => 'Packages'],
                ['name' => 'coupons', 'ar' => 'كوبونات الخصم', 'en' => 'Coupons'],
            ] as $item
        ) {
